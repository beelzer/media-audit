...
from media_audit.models import MovieItem, SeriesItem, MediaType, CodecType
from media_audit.patterns import MediaPatterns, get_patterns
...
def test_scan_path_movies_and_tv(scanner, tmp_path):
    ...
    with patch.object(scanner, '_scan_movies') as mock_scan_movies:
        with patch.object(scanner, '_scan_tv_shows') as mock_scan_tv:
            result = scanner.scan()
